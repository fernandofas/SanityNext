...
export default defineType({
  ...
  fields: [
    ...
    defineField({ name: 'containerPaddingTop', title: 'Margin Top (px)', type: 'number', group: 'dimensions', initialValue: 0, description: 'Space above the slider. Negative values pull it upward (e.g. -50).' }),
    defineField({ name: 'containerPaddingBottom', title: 'Margin Bottom (px)', type: 'number', group: 'dimensions', initialValue: 0, description: 'Space below the slider. Negative values pull it downward (e.g. -50).' }),
